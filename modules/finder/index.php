...
<body onResize="resizeDocument(this)" onLoad="loadSongs('top',currentKey)"> 
<div data-role="header" data-position="inline">
 	<a data-icon="home">Home</a> 
	<h1 id="logo" >PlayMob: Play Mobility!</h1>
	<div id="searchPanel">
		<input type="text" id="inTitle" onkeypress="sendRequestP(event,currentKey)"
		value="Search"
    		onblur="if(value=='') value = 'Search'" 
    		onfocus="if(value=='Search') value = ''">
		<div onclick="sendRequestP(false)"><a id="btnSearch" ></a></div>
	</div>
	<a id="allSongs" onclick="sendRequest(currentKey)">All Songs</a>
</div>
